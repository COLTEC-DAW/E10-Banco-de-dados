...
-- Q4) Listar as contas criadas na agência 'Central'
SELECT conta.Codigo, conta.Saldo, cliente.Nome FROM conta
JOIN cliente ON conta.Cliente_Cpf = cliente.Cpf
JOIN agencia ON conta.Agencia_Codigo = agencia.Codigo
WHERE agencia.Nome = 'Central';

-- Q5) Listar as transações realizadas a partir da conta do 'Joao'
...
-- Q6) Listar as transações realizadas pelo 'Joao' para a conta do 'Pedro'
...
WHERE Cliente_Origem.Nome = 'Joao' AND Cliente_Destino.Nome = 'Pedro';
